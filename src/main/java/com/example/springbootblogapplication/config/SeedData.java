...
import com.example.springbootblogapplication.repository.AuthorityRepository;
...
public class SeedData implements CommandLineRunner {
    ...
    public void run(String... args) throws Exception {
        ...
        if(posts.size()==0){
            ...
            authRepo.findById("ROLE_USER").ifPresent(authorities1::add);
            ...
            authRepo.findById("ROLE_USER").ifPresent(authorities2::add);
            authRepo.findById("ROLE_ADMIN").ifPresent(authorities2::add);
